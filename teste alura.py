...
def jogar():
    ...
    # Time sleep adiciona um intervalo de segundo(s).
    # Entre os códigos para passar a ideia de processamento.
    sleep(1)
    ...
    while tentativa_do_jogador != numero_aleatorio and chances_restantes != 0:
        ...
        tentativa_do_jogador = int(input('\nQual número, entre 1 e 100,'
        ...
        if tentativa_do_jogador == numero_aleatorio:
            ...
            print(
                f'\nParabéns, o número realmente era o {numero_aleatorio},'
            ...
            print(f'\nO número não é {tentativa_do_jogador}. Tente um'
                  f' valor Menor!'
                  f' Você ainda tem {chances_restantes} tentativas.')

        elif tentativa_do_jogador < numero_aleatorio and chances_restantes != 0:
            print(
                f'\nO número não é {tentativa_do_jogador}. Tente um valor Maior!'
                f' Você ainda tem {chances_restantes} Tentativas.')
